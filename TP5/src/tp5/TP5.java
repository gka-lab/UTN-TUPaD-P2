...
public class TP5 {
    ...
    private static void ejercicio1(){
        ...
        Titular titular = new Titular("Germán","34675432");
    ...
    private static void ejercicio2(){
        ...
        Bateria bateria = new Bateria("Williams", 100);
        Celular celular = new Celular("1234567890","Apple","ABC", bateria);
        Usuario usuario = new Usuario("Germán","34675432");
    ...
    private static void ejercicio3(){
        ...
        Editorial editorial = new Editorial("UnaEditorial", "Avenida Siempre Viva 1234");
        Autor autor = new Autor("Isaac Asimov","Estadounidense");
        Libro libro = new Libro("Fundation", "99990000", autor, editorial);
    ...
    private static void ejercicio4(){
       ...
       //Asignacion y agregacion 1 a 1
        Banco banco = new Banco("Galicia", "134456744");
        TarjetaDeCredito tarjetaDeCredito = new TarjetaDeCredito("1234567890","2030-10-10", banco);
        Cliente cliente = new Cliente("Germán","34675432");
    ...
    private static void ejercicio5(){
        ...
        //Asignacion 1 a 1
        Computadora computadora = new Computadora("Dell","FKED12384DDD","Asus","123456");
        Propietario propietario = new Propietario("Germán","34675432");
    ...
    private static void ejercicio6(){
        ...
        //Asociacion unidireccional y agregacion 1 a 1
        ClienteReserva clienteReserva = new ClienteReserva("Germán", "34675432");
        Mesa mesa = new Mesa(9,4);
        Reserva reserva = new Reserva("18-12-2025", "22:00", clienteReserva);
    ...
    private static void ejercicio7(){
        ...
        Conductor conductor = new Conductor("Germán","F3483");
    ...
    private static void ejercicio8(){
        ...
        UsuarioDocumento usuarioDocumento = new UsuarioDocumento("Germán", "ger.kadar@gmail.com");
    ...
    private static void ejercicio9(){
        ...
        Paciente paciente = new Paciente("nombre", "Medicus");
    ...
    private static void ejercicio10(){
        ...
        TitularCuentaBancaria titularCuentaBancaria  = new TitularCuentaBancaria("Germán","34675432");
    ...
    private static void ejercicio11(){
        ...
        Artista artista = new Artista("Attaque 77", "Rock");
        Cancion cancion = new Cancion("Espadas y Serpientes", artista);
    ...
    private static void ejercicio12(){
        ...
        //Asociacion unidireccional y dependencia de uso
        Contribuyente contribuyente = new Contribuyente("Germán", "34675432");
    ...
    private static void ejercicio13(){
        ...
        UsuarioQR usuarioQR = new UsuarioQR("Germán", "ger.kadar@gmail.com");
